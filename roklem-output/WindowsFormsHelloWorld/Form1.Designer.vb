...
' Changes made: 
' - Removed all Microsoft.VisualBasic dependencies, ensuring compatibility with .NET Core.
' - Retained the functionality of the Form1 class and its components without utilizing any non-migratable packages. 
' - Ensured that the form and controls are initialized correctly for WinForms in .NET Core. 
' - Updated comments for clarity regarding migration requirements. 